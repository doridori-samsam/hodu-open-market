...
function ProductOverview({ productdata }) {
  const [totalPrice, setTotalPrice] = useState(productdata[0].price);

  function getTotalPrice(price) {
    setTotalPrice(price * product);
  }
              ...
              <div>
                ...
                <div className="flex items-center md:h-[100px] sl:h-[80px] sm:h-[45px] sl:border-y-[2px] sl:border-disabled">
                  <OrderQtyButton
                    ...
                    price={parseInt(productdata[0].price, 10)}
                    passQty={getTotalPrice}
                  />
                </div>
